...
?>
<h3 class="text-center text-uppercase m-2">Sửa sản phẩm</h3>
<form id="demoForm" action="" method="post" enctype="multipart/form-data" class=" m-0 p-0">
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label for="name">Mã sản phẩm</label>
                <input type="text" class="form-control" placeholder="Auto" readonly name="ma_san_pham" value="<?=$sp['ma_san_pham']?>">
            </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Tên sản phẩm" name="ten_san_pham" value="<?=$sp['ten_san_pham']?>">
                <p class="errors" style="color: red;"><?= isset($errors['ten_san_pham']) ? $errors['ten_san_pham'] : '' ?></p>
            </div>
            <div class="form-group">
                <label for="name">Giá</label>
                <input type="text" class="form-control" placeholder="Giá" name="gia" value="<?=$sp['gia']?>">
                <p class="errors" style="color: red;"><?= isset($errors['gia']) ? $errors['gia'] : '' ?></p>
            </div>
        </div>
        <div class="form-group">
            <label for="">Chi tiết</label>
            <textarea class="form-control" name="chi_tiet" id="summernote" cols="30" rows="10"><?=$sp['chi_tiet']?></textarea>
