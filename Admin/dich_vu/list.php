...
?>
<h3 class="text-center text-uppercase m-2">Quản trị dịch vụ</h3>
<a href="index.php?add" class="btn btn-success mb-4">Thêm mới dịch vụ</a>
    ...
    <table class="table table-hover table-bordered table-light">
        ...
        foreach ($list_nv as $key => $row) : ?>
            <tbody>
                <tr>
                    <td>
                        <input type="checkbox" name="ma_dich_vu[]" id="" value="<?= $row['ma_dich_vu'] ?>" class="checkbox1">
                    </td>
                    <td><?= ++$key ?></td>
