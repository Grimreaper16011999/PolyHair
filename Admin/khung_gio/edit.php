<?php
$kg = kg_select_by_id($_GET['id']);
$coso = kg_select_All();


?>
<h3 class="text-center text-uppercase m-2">Sửa</h3>
<div class="row">
    <div class="col col-md-6">
        <form id="demoForm" action="" method="post" enctype="multipart/form-data" class=" m-0 p-0">
            <div class="form-group">
                <label for="name">Mã khung giờ</label>
                <input type="text" class="form-control" placeholder="Auto" readonly name="ma_khung_gio" value="<?= $kg['ma_khung_gio'] ?>"><br>
                <label for="name">Thời gian</label>
                <input type="text" class="form-control" placeholder="ex: 7h00 - 8h00" name="thoi_gian" value="<?=$kg['thoi_gian']?>">
