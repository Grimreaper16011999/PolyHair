...
try {
    ...
    $list_nv = lich_hen_date_now_nv($manv, $date_now, $firstIndex, $limit);
    // Phân trang lấy số trang 
    $sql = "SELECT count(ma_don) as total FROM dat_lich WHERE ngay_cat=$date_now AND ma_nhan_vien=$manv";
...
?>
<h3 class="text-center text-uppercase m-2">Lịch hẹn hôm nay</h3>
